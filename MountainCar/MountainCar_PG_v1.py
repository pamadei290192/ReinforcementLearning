...
if __name__ == "__main__":
    ...
    # Load checkpoint
    load_path = '/Users/philippeamadei/Desktop/MachineLearning/ReinforcementLearning/MountainCar/Checkpoint/model.ckpt' #"output/weights/CartPole-v0.ckpt"
    save_path = '/Users/philippeamadei/Desktop/MachineLearning/ReinforcementLearning/MountainCar/Checkpoint/model.ckpt' #"output/weights/CartPole-v0-temp.ckpt"
    ...
    for episode in range(EPISODES):
        ...
        while True:
            ...
            if observation_[0] > -0.2:
                reward += 2.5
            if observation_[0] > -0.1:
                reward += 5
            if observation_[0] > 0:
                reward += 10
            if observation_[0] > 0.2:
